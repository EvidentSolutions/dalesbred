...
Check out the test cases under https://github.com/EvidentSolutions/dalesbred/tree/master/dalesbred/src/test/java/fi/evident/dalesbred[dalesbred/src/test/java]
...
----
        dependencies {
            compile 'fi.evident.dalesbred:dalesbred:{revnumber}'
        }
...
----
        dependencies {
            testCompile 'fi.evident.dalesbred:dalesbred-junit:{revnumber}'
        }
----
