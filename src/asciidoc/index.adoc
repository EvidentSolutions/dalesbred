...
an {javadocBase}org/dalesbred/SqlQuery.html[SqlQuery] as a parameter and there's another
...
[source,java,indent=0]
----
        import static org.dalesbred.SqlQuery.namedQuery;
...
[source,java,indent=0]
----
        import static org.dalesbred.SqlQuery.confidential;
