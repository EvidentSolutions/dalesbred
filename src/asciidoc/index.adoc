...
----
        ...
        MyService myService = TransactionalProxyFactory.createTransactionalProxyFor(db, MyService.class, new MyRealService());
...
you can register your functions to {javadocBase}org/dalesbred/instantiation/TypeConversionRegistry.html[TypeConversionRegistry]:
